...
pub fn shinkansen() -> Vec<Mono> {
    return vec![
        ...
        Mono {
            ...
            moto: Some(vec!["牛乳", "卵", "砂糖", "バニラエッセンス"]),
            calorie: Some(232),
        ...
        Mono {
            ...
            comment: "",
            allergen: Some(vec!["小麦", "卵", "大豆"]),
            moto: Some(vec!["小麦粉", "卵", "砂糖", "バター", "大豆", "カカオマス"]),
            calorie: None,
        ...
        Mono {
            ...
            moto: Some(vec!["小麦粉", "チーズ", "マカダミアナッツ"]),
            calorie: None,
